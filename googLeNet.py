...
class GoogLeNetCNN(torch.nn.Module):
    def __init__(self) -> None:
        ...
        self.IncC = torch.nn.ModuleList([
            ...
            torch.nn.Conv2d(480, 64, kernel_size=1, padding=5),
        ])
        ...
        self.IncD = torch.nn.ModuleList([
            ...
            torch.nn.MaxPool2d(kernel_size=3),
            torch.nn.Conv2d(512, 64, kernel_size=1, padding=5),
        ])
        ...
        self.IncG = torch.nn.ModuleList([
            ...
            torch.nn.MaxPool2d(kernel_size=3),
            torch.nn.Conv2d(528, 128, kernel_size=1, padding=5),
        ])
        ...
        self.IncH = torch.nn.ModuleList([
            ...
            torch.nn.MaxPool2d(kernel_size=3, padding=1),
            torch.nn.Conv2d(832, 128, kernel_size=1, padding=2),
        ])
...
if __name__ == "__main__":
    ...
    test = torch.rand((20,3,224,224), dtype=torch.float32)
